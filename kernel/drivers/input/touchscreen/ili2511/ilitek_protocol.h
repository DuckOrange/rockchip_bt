...
int __DLL grid_alloc(struct ilitek_ts_device *dev, struct grids *grid);
...
int __DLL api_read_flash(struct ilitek_ts_device *dev, uint8_t *buf,
			 uint32_t start_addr, uint32_t len);

int __DLL api_read_mp_result(struct ilitek_ts_device *dev,
